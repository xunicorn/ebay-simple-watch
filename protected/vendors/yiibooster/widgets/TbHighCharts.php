...
class TbHighCharts extends CWidget
{
    ...
    public $showDisableLegendsButton = false;
    public $disableLegendsButtonSelector = '';
	...
	protected function registerClientScript()
	{
        ...
        if($this->showDisableLegendsButton && !empty($this->disableLegendsButtonSelector)) {
            $assets->registerScript(
                __CLASS__ . '#' . $this->getId() . '_disableLegendsButton',
                "$('{$this->disableLegendsButtonSelector}').on('click', function() {
